...
def test_send_email_notification_for_questionnaire_without_daybatch(mock_send_email_notification, mock_config):
    print(mock_config)
    assert send_email_notification_for_questionnaire_without_daybatch(mock_config, "DST2106Z") is None
